class BuildRehearsalScheduleWorker
  ...
  def perform(block_length, break_length, days_of_week, end_date, end_time, production_id, time_between_breaks, start_date, start_time)
    ...
    BuildRehearsalScheduleBlocks.new(block_length: block_length, break_length: break_length, days_of_week: days_of_week, end_date: end_date, end_time: end_time, production: Production.find(production_id), time_between_breaks: time_between_breaks, start_date: start_date, start_time: start_time).run
  end
end
