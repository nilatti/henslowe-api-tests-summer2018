...
RSpec.describe 'Scenes API' do
  ...
  describe 'GET api/scenes/:scene_id/french_scenes' do
    before {
      get "/api/scenes/#{scene_id}/french_scenes", params: {scene_id: scene_id}
    }
  ...
  describe 'GET /scenes/:scene_id/french_scenes/:id' do
    before {
      get "/api/scenes/#{scene_id}/french_scenes/#{id}"
    }
  ...
  describe 'POST /scenes/:scene_id/french_scenes' do
    ...
    context 'when request attributes are valid' do
      before { post "/api/scenes/#{scene_id}/french_scenes", params: valid_attributes }
    ...
    context 'when an invalid request' do
      before { post "/api/scenes/#{scene_id}/french_scenes", params: { french_scene: { summary: 'Baby', scene_id: scene_id } } }
  ...
  describe 'PUT /api/french_scenes/:id' do
    ...
    before { put "/api/french_scenes/#{id}", params: valid_attributes }
